...
{
    /// <inheritdoc />
    public partial class SupplierModelAdded : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Transactions_Business", "((Type = 'P' AND SupplierId IS NOT NULL AND CustomerId IS NULL) OR (Type = 'S' AND CustomerId IS NOT NULL AND SupplierId IS NULL))");
                    table.CheckConstraint("CK_Transactions_Type", "Type IN ('P','S')");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PurchaseOrders", x => x.SalesId);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Transactions_Type_DateTime",
                table: "Transactions",
                columns: new[] { "Type", "DateTime" });
        }
